...
////        return ResponseEntity.ok(templateService.searchTemplates(keyword, category, Arrays.stream(colors).collect(Collectors.toSet()), minPrice, maxPrice, createdAfter.atStartOfDay(), createdBefore.atStartOfDay(), sellerName, userId, pageable));
////    }
//}
