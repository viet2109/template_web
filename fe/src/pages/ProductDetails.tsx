            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div className="lg:col-span-8">
                    ...
                    <div className="mt-10">
                        ...
                        <h3 className="text-xl font-semibold mb-2"  style={{ color: 'rgb(46 87 122)' }}>Tính năng nổi bật</h3>
                        <ul className="list-disc list-inside mb-6">
                ...
                <div className="lg:col-span-4">
                    ...
                    <div className="p-6 rounded-lg mb-6" style={{ backgroundColor: 'rgb(242, 239, 231)', color: 'rgb(41, 115, 178)', border: '1px solid rgb(72, 166, 167)' }}>
                        ...
                        <button className="w-full py-3 rounded-lg font-medium mb-3 bg-[#2973B2] hover:bg-[rgb(48,139,216)] cursor-pointer transition duration-200" style={{ color: 'white' }}>
                            Mua ngay
                        </button>
                        <button className="w-full py-3 rounded-lg font-medium bg-[#48A6A7] hover:bg-[#56cdce] cursor-pointer transition duration-200" style={{color: 'white' }}>
                            Thêm vào giỏ
                        </button>
                    </div>
